...
router.get("/customers",logincontroller.authenticate, logincontroller.getAllCustomers);
//http://localhost:3000/customers
router.delete("/user/:userId",logincontroller.authenticate, logincontroller.deleteAccount);
